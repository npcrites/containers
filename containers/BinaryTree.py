...
class BinaryTree():
    ...
    def print_tree(self, traversal_type):
        ...
        a reference on how to write recursive functions on recursive
        data structures.
        '''
    ...
    def __len__helper(node):
        ...
        if node.right is not None:
            y = BinaryTree.__len__helper(node.right)
        else:
            y = 0
        return z + x + y
    ...
    def _height(node):
        ...
        if node is None:
            ...
            left_depth = BinaryTree._height(node.left)
            right_depth = BinaryTree._height(node.right)
